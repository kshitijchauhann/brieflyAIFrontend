...
const OAuthButton = ({ provider, onClick }: OAuthButtonProps) => {
  ...
  return (
    <button
      onClick={onClick}
      className="w-full flex items-center justify-center px-4 py-2.5 border border-neutral-300 rounded-lg hover:bg-neutral-50 transition-colors text-neutral-700 font-medium"
    >
...
export default function OAuthButtons() {
  ...
  return (
    <div className="space-y-3">
      ...
      <OAuthButton provider="linkedin" onClick={() => handleOAuthLogin('linkedin')} />
    </div>
  );
}